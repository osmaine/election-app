...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="nav-item">
        ...
        <li class="btn btn-outline-info"><?= $this->Html->link(__('Admin'), ['controller' => 'users', 'action' => 'admin']) ?></li>
        <li class="btn btn-group btn-outline-success"><?= $this->Html->link(__('Electeur'), ['controller' => 'users', 'action' => 'electeur']) ?></li>
        <li class="btn btn-group btn-outline-success"><?= $this->Html->link(__('Election'), ['controller' => 'users', 'action' => 'index1']) ?></li>
            ...
            <table class="table  table-advance table-hover table-bordered">
                ...
                foreach ($users as $user): ?>
                    <tr style="border: #43AC6A solid 3px">
                        ...
                        <td><?= h($user->fil) ?></td>
                        <td><?php
                            switch (mb_strtoupper(h($user->post))) {
                                case "PR":
                                    echo __('Président');
                                    break;
                                case "DG":
                        ...
                        <td>
                            <div class="btn-group">
                                <?= $this->Html->link(__('<i class="icon_profile"></i>Profile'), '/user/users/view/' . $user->ID, ['class' => 'btn btn-primary', 'escape' => false]) ?>

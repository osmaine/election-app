...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    ...
    <?= $this->Form->postLink(
        ...
        ['confirm' => __('Are you sure you want to delete # {0}?', $user->prenom), 'class' => 'btn btn-danger']
    )
    ?>
                ...
                <div class="col-md-6 ">
                    <div class="form-group text-center" style="position: relative;">
                        ...
                        <div class="text-center img-placeholder" onClick="triggerClick()">
                            ...
                            <?php
                            if ($user->photo != null) {
                                echo $this->Html->image('/' . h($user->photo), ['onClick' => 'triggerClick()', 'id' => 'profileDisplay']);
                        ...
                        echo $this->Form->control('photo', ['type' => 'file', 'label' => 'Profile Image', 'onChange' => 'displayImage(this)', 'id' => 'profileImage', 'class' => 'form-control', 'style' => 'display : none;']); ?>

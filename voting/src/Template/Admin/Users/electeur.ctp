...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="nav-item">
        ...
        <li class="btn btn-group btn-outline-success"><?= $this->Html->link(__('Candidat'), ['controller' => 'users', 'action' => 'candidat']) ?></li>
        ...
        <section class="panel">
            ...
            <table class="table  table-advance table-hover table-bordered">
                ...
                <tr style="border: #43AC6A solid 3px">
                    ...
                    <th><i class="icon_mail_alt"></i><?= mb_strtoupper(__('Email'), 'UTF-8') ?></th>
                ...
                foreach ($users as $admin): ?>
                    <tr style="border: #43AC6A solid 3px">
                        ...
                        <td>
                            <div class="btn-group">
                                <?= $this->Html->link(__('<i class="icon_profile"></i>Profile'), '/admin/users/view/' . $admin->ID, ['class' => 'btn btn-primary', 'escape' => false]) ?>

                                <?php echo $this->Form->postLink(__('<i class="icon_error-circle"></i>Supprimer'), '/admin/supp/' . $admin->ID, ['confirm' => __('Etes-vous sûr de vouloir supprimer {0}?', $admin->nom . ' ' . $admin->prenom), 'class' => 'btn btn-danger', 'escape' => false]);
                                ?>
                            </div>
                        </td>
                    </tr>

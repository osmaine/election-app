...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(__('Nouvelle élection'), ['action' => 'add'], ['confirm' => __('En créant une nouvelle élection les résultats précédents seront rénitialisés'), 'class' => 'btn btn-primary']) ?></li>
    </ul>
</nav>
<?= $this->Flash->render() ?>
    ...
    <div class="col-lg-12">
        <section class="panel">
            <header class="panel-heading">
                <?php echo __('Calendrier électoral') ?>
            </header>
                ...
                foreach ($voteLists as $voteList): ?>
                    <tr style="border: #43AC6A solid 3px">
                        ...
                        <td>
                            <div class="btn-group">
                                <?php
                                echo $this->Html->link(__('Modifier'), ['action' => 'edit', $voteList->ID], ['class' => 'btn btn-success fa fa-edit']);
                                ?>

                                <?php echo $this->Form->postLink(__('Supprimer'), ['action' => 'delete', $voteList->ID], ['confirm' => __('Etes-vous sûr de vouloir supprimer {0}?'), 'class' => 'btn btn-danger fa fa-window-close']);
                                ?>

                    ...
                    <div class="col-md-3 col-xs-12">
					 ...
					 <span class="input-group-addon">
						<span class="glyphicon glyphicon-calendar"></span>
                            ...
                            <?php
                            echo $this->Form->text('end_election', ['placeholder' => 'End election', 'class' => 'form-control datetimepicker']); ?>
                        </div>
                    </div>
                </div>
                <div
...
<?php echo $this->Html->script(['jquery', 'phonejs/moment-with-locales', 'bootstrap-datetimepicker']) ?>
